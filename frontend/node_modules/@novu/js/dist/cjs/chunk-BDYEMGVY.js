  ...
  updatePreference(args) {
    return chunk7B52C2XE_js.__async(this, null, function* () {
      ...
      return updateSubscriptionPreference({
        ...
        cache: chunk7B52C2XE_js.__privateGet(this, _cache),
        useCache: chunk7B52C2XE_js.__privateGet(this, _useCache),
        args: chunk7B52C2XE_js.__spreadProps(chunk7B52C2XE_js.__spreadValues({}, args), { subscriptionId: this.identifier })
      });
    });
  }
  bulkUpdatePreferences(args) {
    return chunk7B52C2XE_js.__async(this, null, function* () {
      ...
      return bulkUpdateSubscriptionPreference({
        ...
        cache: chunk7B52C2XE_js.__privateGet(this, _cache),
        useCache: chunk7B52C2XE_js.__privateGet(this, _useCache),
        args: args.map((arg) => chunk7B52C2XE_js.__spreadProps(chunk7B52C2XE_js.__spreadValues({}, arg), { subscriptionId: this.identifier }))
      });
    });
  }
  delete() {
...
var InboxService = class {
  ...
  updateSubscription({
    ...
    return chunk7B52C2XE_js.__privateGet(this, _httpClient).patch(`${INBOX_ROUTE}/topics/${topicKey}/subscriptions/${identifier}`, chunk7B52C2XE_js.__spreadValues({
      name
  ...
  updateSubscriptionPreference({
    ...
    return chunk7B52C2XE_js.__privateGet(this, _httpClient).patch(`${INBOX_ROUTE}/subscriptions/${subscriptionIdentifier}/preferences/${workflowId}`, {
      enabled,
      condition,
      email,
      sms,
