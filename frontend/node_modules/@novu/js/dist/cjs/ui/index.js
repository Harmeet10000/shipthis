...
var CheckboxPrimitive = require('@kobalte/core/checkbox');
...
function NovuProvider(props) {
  const novu = solidJs.createMemo(() => {
    ...
    return novuValue || new chunkBDYEMGVY_js.Novu(props.options);
  });
    ...
    eventHandler: (_0) => chunk7B52C2XE_js.__async(void 0, [_0], function* ({
      ...
      if (currentTabs.length > 0) {
        for (const tab of currentTabs) {
          ...
          const matchesTagFilter = chunkBDYEMGVY_js.checkNotificationTagFilter(notification.tags, tabTags);
          const matchesDataFilterCriteria = chunkBDYEMGVY_js.checkNotificationDataFilter(notification.data, tabDataFilterCriteria);
...
var _tmpl$9 = /* @__PURE__ */ web.template(`<svg viewBox="0 0 8 6"fill=none xmlns=http://www.w3.org/2000/svg><path d="M2.99994 4.58847L7.33298 0L8 0.705765L2.99994 6L0 2.82356L0.666549 2.11779L2.99994 4.58847Z"fill=currentColor>`);
var Check = (props) => {
  return (() => {
    var _el$ = _tmpl$9();
    web.spread(_el$, props, true, true);
...
var IconRenderer = (props) => {
  return web.createComponent(IconRendererWrapper, {
    ...
    get fallback() {
      return web.createComponent(props.fallback, {
        get ["class"]() {
          return props.class;
        }
      });
...
var _tmpl$26 = /* @__PURE__ */ web.template(`<span>`);
var _tmpl$27 = /* @__PURE__ */ web.template(`<span><div>`);
...
var _tmpl$28 = /* @__PURE__ */ web.template(`<svg width=6 height=6 viewBox="0 0 6 6"fill=none xmlns=http://www.w3.org/2000/svg><path d="M5.00175 1.70402L0.705765 6L0 5.29424L4.29548 0.998253H0.509608V0H6V5.49039H5.00175V1.70402Z"fill=currentColor>`);
...
var _tmpl$29 = /* @__PURE__ */ web.template(`<button>`);
...
var _tmpl$30 = /* @__PURE__ */ web.template(`<button type=button>`);
...
function getCurlCommand() {
  ...
  return `curl -X POST   ${DEFAULT_BACKEND_URL}/${chunkBDYEMGVY_js.DEFAULT_API_VERSION}/events/trigger   -H 'Authorization: Keyless ${identifier}'   -H 'Content-Type: application/json'   -d '{
    "name": "hello-world",
    "to": {
  ...
  return web.createComponent(CheckboxPrimitive__namespace.Root, web.mergeProps({
    ...
    get children() {
      return [web.createComponent(CheckboxPrimitive__namespace.Input, {
        ...
        get children() {
          return web.createComponent(CheckboxPrimitive__namespace.Indicator, {
            get children() {
...
var _tmpl$212 = /* @__PURE__ */ web.template(`<div><span>`);
...
var _tmpl$39 = /* @__PURE__ */ web.template(`<button>`);
...
var _tmpl$41 = /* @__PURE__ */ web.template(`<div role=tabpanel>`);
...
var _tmpl$43 = /* @__PURE__ */ web.template(`<div role=tablist>`);
var _tmpl$213 = /* @__PURE__ */ web.template(`<div class="nt-relative nt-z-[-1]">`);
...
var _tmpl$44 = /* @__PURE__ */ web.template(`<input>`);
...
var _tmpl$45 = /* @__PURE__ */ web.template(`<span class=nt-text-sm>`);
var _tmpl$214 = /* @__PURE__ */ web.template(`<span><span>`);
...
var TimeSelect = (props) => {
  const style = useStyle();
  const time = solidJs.createMemo(() => {
    var _a;
    return (_a = props.value) == null ? void 0 : _a.split(" ")[0];
  });
  const amPm = solidJs.createMemo(() => {
    var _a;
    if (!time()) return "";
    ...
    get children() {
      return [web.createComponent(Dropdown.Trigger, {
        ...
        get children() {
          ...
          web.insert(_el$2, (() => {
            var _c$ = web.memo(() => !!amPm());
            return () => _c$() && (() => {
              var _el$4 = _tmpl$310();
              web.insert(_el$4, amPm);
              return _el$4;
            })();
          })(), null);
        ...
        get children() {
          return web.createComponent(solidJs.For, {
            each: hours,
            children: (hour) => web.createComponent(TimeSelectItem, {
              hour,
              get isSelected() {
...
var _tmpl$46 = /* @__PURE__ */ web.template(`<span><span>`);
...
var useNotificationsInfiniteScroll = (props) => {
  ...
  solidJs.createEffect(() => {
    const listener = ({ data: data2 }) => {
      if (!data2 || !chunkBDYEMGVY_js.isSameFilter(filter, data2.filter)) {
        return;
      }
  ...
  solidJs.createEffect(() => chunk7B52C2XE_js.__async(void 0, null, function* () {
    ...
    if (chunkBDYEMGVY_js.isSameFilter(filter, newFilter)) {
      return;
    }
...
var _tmpl$216 = /* @__PURE__ */ web.template(`<div><div></div><div>`);
...
var _tmpl$55 = /* @__PURE__ */ web.template(`<div><div>`);
...
var _tmpl$56 = /* @__PURE__ */ web.template(`<label><input type=checkbox class=nt-sr-only><div>`);
var Switch2 = (props) => {
  const style = useStyle();
  const handleChange = () => {
    var _a;
...
var _tmpl$217 = /* @__PURE__ */ web.template(`<div><div><div><div><span></span></div></div><span>`);
...
var _tmpl$59 = /* @__PURE__ */ web.template(`<svg xmlns=http://www.w3.org/2000/svg fill=none viewBox="0 0 16 16"><path fill=currentColor d="M8 13A5 5 0 1 1 8 3a5 5 0 0 1 0 10Zm0-1a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm.5-4.75V9.5H9v1H7v-1h.5V8.25H7v-1h1.5ZM8.75 6a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z">`);
var Info = (props) => {
  return (() => {
    var _el$ = _tmpl$59();
    web.spread(_el$, props, true, true);
...
var _tmpl$61 = /* @__PURE__ */ web.template(`<div><div><span data-localization=preferences.group.info></span></div><div>`);
var _tmpl$218 = /* @__PURE__ */ web.template(`<div><div><div><span></span></div><div><span>`);
    ...
    get children() {
      ...
      web.insert(_el$, web.createComponent(Collapsible, {
        ...
        get children() {
          ...
          web.insert(_el$0, web.createComponent(solidJs.Index, {
            get each() {
              return preferences();
            },
      ...
      web.effect((_p$) => {
        ...
        _v$0 !== _p$.n && web.setAttribute(_el$4, "data-open", _p$.n = _v$0);
        _v$1 !== _p$.s && web.className(_el$5, _p$.s = _v$1);
        _v$10 !== _p$.h && web.className(_el$6, _p$.h = _v$10);
        _v$11 !== _p$.r && web.setAttribute(_el$6, "data-open", _p$.r = _v$11);
        return _p$;
      }, {
        e: void 0,
        t: void 0,
...
var _tmpl$63 = /* @__PURE__ */ web.template(`<span data-localization=preferences.schedule.dayScheduleCopy.title>`);
var _tmpl$219 = /* @__PURE__ */ web.template(`<span data-localization=preferences.schedule.dayScheduleCopy.selectAll>`);
var _tmpl$312 = /* @__PURE__ */ web.template(`<div>`);
var _tmpl$410 = /* @__PURE__ */ web.template(`<span>`);
...
var DayScheduleCopy = (props) => {
  ...
  const [selectedDays, setSelectedDays] = solidJs.createSignal([props.day()]);
  const [isAllSelected, setIsAllSelected] = solidJs.createSignal(false);
  const allWeekDaysSelected = solidJs.createMemo(() => selectedDays().length === weekDays.length);
  const reset = () => {
    setSelectedDays([props.day()]);
    setIsAllSelected(false);
    setIsOpen(false);
  };
  const onOpenChange = solidJs.createMemo(() => (isOpen2) => {
    if (isOpen2) {
  ...
  return web.createComponent(Tooltip.Root, {
    get children() {
      return [web.createComponent(Tooltip.Trigger, {
        ...
        asChild: (childProps) => web.createComponent(Dropdown.Root, {
          placement: "right",
          offset: 0,
          get open() {
            return isOpen();
          ...
          get children() {
            return [web.createComponent(Dropdown.Trigger, {
              ...
              get children() {
                return [(() => {
                  var _el$ = _tmpl$63();
                  web.insert(_el$, () => t("preferences.schedule.dayScheduleCopy.title"));
                  web.effect(() => web.className(_el$, style({
                  ...
                  var _el$2 = _tmpl$219();
                  web.insert(_el$2, web.createComponent(Checkbox, {
                    get checked() {
                  ...
                  web.insert(_el$2, () => t("preferences.schedule.dayScheduleCopy.selectAll"), null);
                  web.effect(() => web.className(_el$2, style({
                  ...
                  children: (day) => (() => {
                    var _el$4 = _tmpl$410();
                    web.setAttribute(_el$4, "data-localization", `preferences.schedule.${day}`);
                    web.insert(_el$4, web.createComponent(Checkbox, {
                      value: "checked",
                    ...
                    web.insert(_el$4, () => t(`preferences.schedule.${day}`), null);
                  ...
                  var _el$3 = _tmpl$312();
                  web.insert(_el$3, web.createComponent(Button, {
                    onClick: () => {
                      var _a, _b, _c, _d;
                      ...
                      if (dayToCopy) {
                        (_d = props.schedule()) == null ? void 0 : _d.update({
                          weeklySchedule: chunk7B52C2XE_js.__spreadValues(chunk7B52C2XE_js.__spreadValues({}, (_c = props.schedule()) == null ? void 0 : _c.weeklySchedule), daysToCopy.reduce((acc, day) => {
                            acc[day] = dayToCopy;
                            return acc;
                          }, {}))
                        });
...
var _tmpl$220 = /* @__PURE__ */ web.template(`<span>`);
...
var ScheduleBodyColumn = (props) => {
  ...
  return (() => {
    ...
    web.effect(() => web.className(_el$5, style({
...
var ScheduleTable = (props) => {
  ...
  const isScheduleDisabled = solidJs.createMemo(() => {
    var _a, _b;
    return !((_b = (_a = props.globalPreference) == null ? void 0 : _a.schedule) == null ? void 0 : _b.isEnabled);
  });
  const schedule = solidJs.createMemo(() => {
    var _a;
    return (_a = props.globalPreference) == null ? void 0 : _a.schedule;
  });
  return (() => {
    var _el$6 = _tmpl$64();
    web.insert(_el$6, web.createComponent(ScheduleTableHeader, {
      get schedule() {
        return schedule();
      },
      get children() {
        return [web.createComponent(ScheduleTableHeaderColumn, {
          get schedule() {
            return schedule();
          },
          "class": "nt-flex-1",
        ...
        }), web.createComponent(ScheduleTableHeaderColumn, {
          get schedule() {
            return schedule();
          },
          "class": "nt-min-w-[74px]",
    ...
    web.insert(_el$6, web.createComponent(ScheduleTableBody, {
      get schedule() {
        return schedule();
      },
      get children() {
        return web.createComponent(solidJs.Index, {
          each: weekDays,
          children: (day) => {
            const isDayDisabled = solidJs.createMemo(() => {
              var _a, _b, _c;
              return !((_c = (_b = (_a = schedule()) == null ? void 0 : _a.weeklySchedule) == null ? void 0 : _b[day()]) == null ? void 0 : _c.isEnabled);
            });
            return web.createComponent(ScheduleTableRow, {
              get schedule() {
                return schedule();
              },
              get children() {
                return [web.createComponent(ScheduleBodyColumn, {
                  get schedule() {
                    return schedule();
                  },
                  "class": "nt-flex-1 nt-flex nt-items-center nt-gap-2",
                  get children() {
                    return [web.createComponent(Switch2, {
                      get state() {
                      ...
                      onChange: (state) => {
                        ...
                        (_i = schedule()) == null ? void 0 : _i.update({
                          weeklySchedule: chunk7B52C2XE_js.__spreadProps(chunk7B52C2XE_js.__spreadValues({}, (_f = schedule()) == null ? void 0 : _f.weeklySchedule), {
                            [day()]: chunk7B52C2XE_js.__spreadValues(chunk7B52C2XE_js.__spreadProps(chunk7B52C2XE_js.__spreadValues({}, (_h = (_g = schedule()) == null ? void 0 : _g.weeklySchedule) == null ? void 0 : _h[day()]), {
                              isEnabled
                            }), hasNoHours && {
                              hours: [{
                                start: "09:00 AM",
                      ...
                      var _el$7 = _tmpl$220();
                      web.insert(_el$7, () => t(`preferences.schedule.${day()}`), null);
                      web.insert(_el$7, web.createComponent(DayScheduleCopy, {
                        day,
                        schedule,
                        get disabled() {
                          return isScheduleDisabled();
                      ...
                      web.effect((_p$) => {
                        ...
                        _v$3 !== _p$.e && web.className(_el$7, _p$.e = _v$3);
                        _v$4 !== _p$.t && web.setAttribute(_el$7, "data-localization", _p$.t = _v$4);
                        return _p$;
                      }, {
                        e: void 0,
                        t: void 0
                ...
                }), web.createComponent(ScheduleBodyColumn, {
                  get schedule() {
                    return schedule();
                  },
                  get children() {
                    return web.createComponent(TimeSelect, {
                      get disabled() {
                      ...
                      onChange: (value) => {
                        var _a, _b, _c, _d, _e, _f, _g, _h, _i;
                        (_i = schedule()) == null ? void 0 : _i.update({
                          weeklySchedule: chunk7B52C2XE_js.__spreadProps(chunk7B52C2XE_js.__spreadValues({}, (_a = schedule()) == null ? void 0 : _a.weeklySchedule), {
                            [day()]: chunk7B52C2XE_js.__spreadProps(chunk7B52C2XE_js.__spreadValues({}, (_c = (_b = schedule()) == null ? void 0 : _b.weeklySchedule) == null ? void 0 : _c[day()]), {
                              hours: [{
                                start: value,
    ...
    web.effect(() => web.className(_el$6, style({
      key: "scheduleTable",
      className: "nt-flex nt-flex-col nt-gap-1",
      context: {
        schedule: schedule()
...
var _tmpl$65 = /* @__PURE__ */ web.template(`<button aria-label=Schedule tabindex=0>`);
var _tmpl$221 = /* @__PURE__ */ web.template(`<div class=nt-max-w-56>`);
var _tmpl$313 = /* @__PURE__ */ web.template(`<div><span data-localization=preferences.schedule.title>`);
var _tmpl$411 = /* @__PURE__ */ web.template(`<div><span>`);
var _tmpl$510 = /* @__PURE__ */ web.template(`<div><span data-localization=preferences.schedule.description></span><div><span data-localization=preferences.schedule.info>`);
var _tmpl$66 = /* @__PURE__ */ web.template(`<div>`);
var _tmpl$73 = /* @__PURE__ */ web.template(`<div class="nt-w-full nt-border-t nt-border-neutral-alpha-100">`);
var ScheduleRowHeader = (props) => {
  ...
  return (() => {
    ...
    web.effect((_p$) => {
      ...
      _v$ !== _p$.e && web.className(_el$, _p$.e = _v$);
      _v$2 !== _p$.t && web.setAttribute(_el$, "aria-expanded", _p$.t = _v$2);
      _v$3 !== _p$.a && web.setAttribute(_el$, "data-open", _p$.a = _v$3);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
var ScheduleRowLabel = (props) => {
  ...
  return (() => {
    ...
    web.insert(_el$2, web.createComponent(IconRenderer, {
    ...
    web.insert(_el$3, () => t("preferences.schedule.title"));
    web.insert(_el$2, web.createComponent(Tooltip.Root, {
      get children() {
        return [web.createComponent(Tooltip.Trigger, {
          ...
          get children() {
            var _el$4 = _tmpl$221();
            web.insert(_el$4, () => t("preferences.schedule.headerInfo"));
            return _el$4;
          }
        })];
      }
    ...
    web.effect((_p$) => {
      ...
      _v$5 !== _p$.t && web.className(_el$3, _p$.t = _v$5);
      _v$6 !== _p$.a && web.setAttribute(_el$3, "data-open", _p$.a = _v$6);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
  ...
  return (() => {
    ...
    web.insert(_el$5, web.createComponent(Switch2, {
      ...
      onChange: (state) => {
        ...
        (_b = props.schedule()) == null ? void 0 : _b.update(chunk7B52C2XE_js.__spreadValues({
          isEnabled
    ...
    web.insert(_el$6, web.createComponent(IconRenderer, {
      iconKey: "arrowDropDown",
      get ["class"]() {
        return style({
          key: "moreTabs__icon",
    ...
    web.effect((_p$) => {
      ...
      _v$7 !== _p$.e && web.className(_el$5, _p$.e = _v$7);
      _v$8 !== _p$.t && web.className(_el$6, _p$.t = _v$8);
      _v$9 !== _p$.a && web.setAttribute(_el$6, "data-open", _p$.a = _v$9);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
var ScheduleRowBody = (props) => {
  ...
  return (() => {
    ...
    web.insert(_el$8, () => t("preferences.schedule.description"));
    web.insert(_el$7, web.createComponent(ScheduleTable, {
      get globalPreference() {
        return props.globalPreference;
      }
    }), _el$9);
    web.insert(_el$9, web.createComponent(IconRenderer, {
      iconKey: "info",
      get ["class"]() {
        return style({
    ...
    web.insert(_el$0, () => t("preferences.schedule.info"));
    web.effect((_p$) => {
      var _v$0 = style({
        key: "scheduleBody",
      ...
      _v$0 !== _p$.e && web.className(_el$7, _p$.e = _v$0);
      _v$1 !== _p$.t && web.className(_el$8, _p$.t = _v$1);
      _v$10 !== _p$.a && web.className(_el$9, _p$.a = _v$10);
      _v$11 !== _p$.o && web.className(_el$0, _p$.o = _v$11);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
var ScheduleRow = (props) => {
  ...
  const [isOpened, setIsOpened] = solidJs.createSignal((_c = (_b = (_a = props.globalPreference) == null ? void 0 : _a.schedule) == null ? void 0 : _b.isEnabled) != null ? _c : false);
  return [(() => {
    var _el$1 = _tmpl$66();
    web.insert(_el$1, web.createComponent(ScheduleRowHeader, {
      schedule,
      isOpened,
      setIsOpened,
      get children() {
        return [web.createComponent(ScheduleRowLabel, {
          schedule,
          isOpened
        }), web.createComponent(ScheduleRowActions, {
          schedule,
          isOpened,
    ...
    web.insert(_el$1, web.createComponent(Collapsible, {
      get open() {
        return isOpened();
      },
      get children() {
        return web.createComponent(ScheduleRowBody, {
          get globalPreference() {
            return props.globalPreference;
          },
          isOpened
    ...
    web.effect(() => web.className(_el$1, style({
...
var Preferences = () => {
  ...
  return (() => {
    ...
    web.insert(_el$, web.createComponent(solidJs.Show, {
      ...
      get children() {
        return web.createComponent(ScheduleRow, {
          get globalPreference() {
            return allPreferences().globalPreference;
          }
        });
...
var _tmpl$69 = /* @__PURE__ */ web.template(`<div><div data-localization=preferences.title>`);
...
var _tmpl$70 = /* @__PURE__ */ web.template(`<strong>`);
var _tmpl$222 = /* @__PURE__ */ web.template(`<em>`);
var _tmpl$314 = /* @__PURE__ */ web.template(`<p>`);
var Bold = (props) => {
  const style = useStyle();
  return (() => {
    var _el$ = _tmpl$70();
...
var Markdown = (props) => {
  ...
  const style = useStyle();
  const tokens = solidJs.createMemo(() => chunkCCAUG7YI_js.parseMarkdownIntoTokens(local.children));
  return (() => {
    var _el$3 = _tmpl$314();
      ...
      children: (token) => {
        if (token.type === "boldItalic") {
          return web.createComponent(Bold, {
            ...
            get children() {
              return web.createComponent(Italic, {
                get appearanceKey() {
...
var _tmpl$74 = /* @__PURE__ */ web.template(`<div><span>:</span><select><option value=AM>AM</option><option value=PM>PM`);
var TimePicker = (props) => {
  ...
  return (() => {
    ...
    web.insert(_el$, web.createComponent(Input2, {
      size: "sm",
      type: "number",
      min: "1",
      max: "12",
...
var _tmpl$75 = /* @__PURE__ */ web.template(`<div><div><p></p></div><div>`);
...
var _tmpl$76 = /* @__PURE__ */ web.template(`<div><span>`);
var _tmpl$223 = /* @__PURE__ */ web.template(`<span>`);
var SNOOZE_PRESETS = [{
...
var _tmpl$77 = /* @__PURE__ */ web.template(`<span>`);
var _tmpl$224 = /* @__PURE__ */ web.template(`<a><div></div><div><div></div><div></div></div><div class="nt-w-1.5 nt-flex nt-justify-center nt-shrink-0">`);
var _tmpl$315 = /* @__PURE__ */ web.template(`<img>`);
var _tmpl$412 = /* @__PURE__ */ web.template(`<div>`);
  ...
  return (() => {
    ...
    web.insert(_el$3, web.createComponent(solidJs.Show, {
      ...
      get fallback() {
        return (() => {
          var _el$0 = _tmpl$412();
          web.insert(_el$0, () => renderNotificationActions(props.notification, status));
          web.effect(() => web.className(_el$0, style({
...
var _tmpl$79 = /* @__PURE__ */ web.template(`<div>`);
var _tmpl$225 = /* @__PURE__ */ web.template(`<p data-localization=notifications.emptyNotice>`);
var _tmpl$316 = /* @__PURE__ */ web.template(`<div><p>Trigger your notification. No setup needed.</p><p>Temporary &lt;Inbox />, data will expire in 24h. Connect API key to persists messages, enable
...
var _tmpl$80 = /* @__PURE__ */ web.template(`<div>`);
var _tmpl$226 = /* @__PURE__ */ web.template(`<div><div>`);
...
var _tmpl$83 = /* @__PURE__ */ web.template(`<div>`);
...
var useSubscription = (options) => {
  ...
  const identifier = () => {
    ...
    return (_a = options.identifier) != null ? _a : chunkCCAUG7YI_js.buildSubscriptionIdentifier({ topicKey: options.topicKey, subscriberId, contextKey });
  };
  const [loading, setLoading] = solidJs.createSignal(true);
  const [subscription, { mutate, refetch }] = solidJs.createResource(
    options || {},
    (_0) => chunk7B52C2XE_js.__async(void 0, [_0], function* ({ topicKey, identifier: identifier2, workflowIds, tags }) {
      try {
...
var _tmpl$317 = /* @__PURE__ */ web.template(`<div><label>`);
...
var _tmpl$318 = /* @__PURE__ */ web.template(`<div>`);
var SubscriptionPreferences = (props) => {
  ...
  solidJs.createEffect(() => {
    setDynamicLocalization((prev) => {
      var _a, _b;
      return chunk7B52C2XE_js.__spreadValues(chunk7B52C2XE_js.__spreadValues({}, prev), (_b = (_a = props.subscription) == null ? void 0 : _a.preferences) == null ? void 0 : _b.reduce((acc, preference) => {
        var _a2, _b2;
...
var SubscriptionCog = (props) => {
  ...
  const preferences = solidJs.createMemo(() => props.preferences);
  const hasSubscription = solidJs.createMemo(() => !!subscription());
  const hasPreferences = solidJs.createMemo(() => {
  ...
  const renderTrigger = (triggerProps) => web.createComponent(solidMotionone.Presence, {
    ...
    get children() {
      return web.createComponent(solidJs.Show, {
        get when() {
          return web.memo(() => !!hasSubscription())() && hasPreferences();
        },
        get children() {
...
var Renderer = (props) => {
  const inboxComponents = solidJs.createMemo(() => [...props.nodes.entries()].filter(([_, node]) => !SUBSCRIPTION_COMPONENTS.includes(node.name)).map(([element, _]) => element));
  const subscriptionComponents = solidJs.createMemo(() => [...props.nodes.entries()].filter(([_, node]) => SUBSCRIPTION_COMPONENTS.includes(node.name)).map(([element, _]) => element));
  solidJs.onMount(() => {
    var _a;
              ...
              return web.createComponent(FocusManagerProvider, {
                get children() {
                  return web.createComponent(InboxProvider, {
                    ...
                    get children() {
                      return [web.createComponent(InboxComponentsRenderer, {
                        get elements() {
                      ...
                      }), web.createComponent(SubscriptionComponentsRenderer, {
                        get elements() {
...
var NovuUI = class {
  constructor(props) {
    ...
    chunk7B52C2XE_js.__privateSet(this, _preferencesSort, preferencesSort);
    chunk7B52C2XE_js.__privateSet(this, _setPreferencesSort, setPreferencesSort);
  ...
  updatePreferencesSort(preferencesSort) {
    chunk7B52C2XE_js.__privateGet(this, _setPreferencesSort).call(this, () => preferencesSort);
  }
...
mountComponentRenderer_fn = function() {
  ...
  const dispose = web.render(() => {
    ...
    return web.createComponent(Renderer, {
      ...
      get preferencesSort() {
        var _a;
        return chunk7B52C2XE_js.__privateGet(_a = _self$, _preferencesSort).call(_a);
      },
      get routerPush() {
        var _a;
